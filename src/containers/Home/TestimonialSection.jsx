...
const TestimonialSection = () => {
  useGSAP(() => {
    ...
    testimonyTimeline.fromTo("#circle-text2", {
      y: 50,
    }, {
      y: -50
    }, "<")
  ...
  useGSAP(() => {
      ...
      myTl.to(document.body, { background: "linear-gradient(to left, #fe710b, #ffb804)", color: "white", borderColor: "white", duration: 0 })
      myTl.to(["#testimonial-card-1", "#testimonial-card-2", "#testimonial-card-3", "#testimonial-card-4", "#testimonial-card-5"], {borderColor: "white", duration: 0 }, "<")
  }, [])
