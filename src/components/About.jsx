  ...
  return (
    <div className="h-screen flex justify-between">
      ...
      <div className="flex flex-col justify-center max-w-[20%] mr-[10rem] gap-3">
        ...
        <h4 className="text-4xl font-semibold">BE PROACTIVE NOT REACTIVE ABOUT YOUR IMMUNITY</h4>
        <h6 className="text-xl">No one gives a f*ck about their immune system unless they have to... and it took us a pandemic to realize that. BOOST is here to fix that.</h6>
